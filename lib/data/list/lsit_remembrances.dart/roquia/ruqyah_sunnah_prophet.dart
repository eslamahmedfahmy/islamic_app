...
//  الرقيه من السنه النبويه

List<RoquiaModel> ruqyahSunnahProphet = [
  RoquiaModel(text: 'الرُّقية الشرعية من السنة النبوية'),
  RoquiaModel(
      text:
  ...
  RoquiaModel(text: 'أعوذُ بكلماتِ اللهِ التامَّاتِ مِن شرِّ ما خَلق.'),
  RoquiaModel(
      text:
  ...
  RoquiaModel(text: 'اللَّهُمَّ اشْفِ عَبْدَكَ، وصَدِّقْ رَسُولَك.'),
  RoquiaModel(
      text:
