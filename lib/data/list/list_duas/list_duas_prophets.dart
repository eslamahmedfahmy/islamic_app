import 'package:islam_app/models/text_remembrances.dart';

//   'أدعية الأنبياء'
List<TextRemembrancesModel> duasProphets = [
  TextRemembrancesModel(
      textNumber: '١',
      text2:
          'رَبَّنَا ظَلَمْنَا أَنفُسَنَا وَإِن لَّمْ تَغْفِرْ لَنَا وَتَرْحَمْنَا لَنَكُونَنَّ مِنَ الْخَاسِرِينَ". [الأعراف - 23].',
      text3: 'آدم علية السلام.',
      repeat: '١',
      copy:
          'رَبَّنَا ظَلَمْنَا أَنفُسَنَا وَإِن لَّمْ تَغْفِرْ لَنَا وَتَرْحَمْنَا لَنَكُونَنَّ مِنَ الْخَاسِرِينَ". [الأعراف - 23].'),
  TextRemembrancesModel(
  ...
  TextRemembrancesModel(
      ...
      text3: 'زكريا علية السلام.',
      repeat: '١',
      copy:
          'رَبِّ هَبْ لِي مِن لَّدُنْكَ ذُرِّيَّةً طَيِّبَةً إِنَّكَ سَمِيعُ الدُّعَاء. [آل عمران - 38]. \n رَبِّ لَا تَذَرْنِي فَرْداً وَأَنتَ خَيْرُ الْوَارِثِينَ. [الأنبياء - 89].'),
  TextRemembrancesModel(
      textNumber: '١٣',
      text2: 'إِنَّمَا أَشْكُو بَثِّي وَحُزْنِي إِلَى اللَّهِ. [يوسف - 86].',
      text3: 'يعقوب علية السلام.',
      repeat: '١',
      copy: 'إِنَّمَا أَشْكُو بَثِّي وَحُزْنِي إِلَى اللَّهِ. [يوسف - 86].'),
];
